...
# =====================================================
# CORS — any *.lovable.app subdomain is allowed
# (covers live app + preview deploys + future renames,
# so you never need to hardcode a project URL again)
# =====================================================
...
logger.info("CORS configured: allowing all *.lovable.app origins")
